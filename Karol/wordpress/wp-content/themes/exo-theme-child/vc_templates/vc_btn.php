...
?>
	<div id="<?php echo esc_attr($button_id); ?>" class="<?php echo esc_attr( trim( $css_class ) ); ?> vc_btn3-<?php echo esc_attr( $align ); ?>"><?php
if ( $use_link ):
	?>
	<style type="text/css" scoped>
		#<?php echo esc_attr($button_id); ?>  .btn:hover:before {
			background-color: <?php echo esc_attr( $custom_btn_bg_hover ); ?> !important;
		}
		#<?php echo esc_attr($button_id); ?>  .btn:hover {
			border-color: <?php echo esc_attr( $custom_btn_bg_hover ); ?> !important;
		}
	</style> 
	<a class="<?php echo esc_attr( $button_type ); ?> <?php echo esc_attr( $button_size ); ?> <?php echo esc_attr( trim( $button_class ) ); ?>"
