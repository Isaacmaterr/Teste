...
$team_layout_color = get_post_meta(get_the_ID(),'cs_team_layout_color',true);
?>
<article id="cs_post_<?php the_ID(); ?>" <?php post_class(); ?>>
	<div class="cs-item-team style2 exo-same-height <?php echo ''.$team_layout_color; ?>">
		<div class="cs-single-team-inner clearfix">
			<div class="cs-team-media w50 wpb_column">
				<?php the_post_thumbnail('large'); ?>
			</div>
			<div class="cs-team-details w50 wpb_column">
