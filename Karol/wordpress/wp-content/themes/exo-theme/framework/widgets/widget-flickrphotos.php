...
/* ==  Widget Setup ==============================*/
	...
	function __construct(){
		...
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'ft_flickr_widget', 'description' => __('A widget that displays Flickr photos.', 'famethemes') );
		
		/* Widget control settings. */
		$control_ops = array( 'id_base' => 'ft_flickr_widget' );

		/* Create the widget. */
		parent::__construct( 'ft_flickr_widget', __('Fame Flickr', 'famethemes'), $widget_ops, $control_ops );
	}
...
?>
        ...
        <span class="flickr-brand"><a href="<?php echo $instance['stream_url'] ?>" target="_blank"><?php _e('View stream on flickr', 'famethemes'); ?></a></span>
        <?php endif; ?>
<?php 
...
/* ==  Widget Settings ==============================*/
	...
	function form( $instance ) {
		...
		<p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e('Title:', 'famethemes') ?></label>
            <input class="widefat" type="text" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" value="<?php echo $instance['title']; ?>" />
        </p>

		<!-- Description: Textarea Input -->
		<p>
            <label for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e('Description:', 'famethemes'); ?></label>
		...
		<p>
            <label for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php _e('Flickr ID:', 'famethemes'); ?></label>
            ...
            <br /><span class="helper"><?php _e('Look your ID here,', 'famethemes'); ?> <a href="<?php echo $flirck_url ?>" target="_blank">idGettr</a>.</span>
        </p>
		...
		<p>
            <label for="<?php echo $this->get_field_id( 'number' ); ?>">
               <?php _e('Number of Photos:', 'famethemes'); ?>
            </label>
                ...
                <br /><span class="helper"><?php _e('Up to 10 photos allowed.', 'famethemes'); ?></span>
        </p>
        <p>
            <label for="<?php echo $this->get_field_id( 'stream_url' ); ?>"><?php _e('Stream url:', 'famethemes'); ?></label>
