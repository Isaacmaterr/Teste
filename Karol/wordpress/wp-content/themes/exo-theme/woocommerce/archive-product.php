                ...
                <?php if (isset( $_GET['has_sidebar'] ) && $_GET['has_sidebar'] == 'true' ) : ?>
                    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                        <?php if ( is_active_sidebar( 'woocommerce-widget-area' ) ) : ?>
                            <div id="secondary" class="widget-area woocommerce-widget" role="complementary">
                                <?php dynamic_sidebar( 'woocommerce-widget-area' ); ?>
                            </div><!-- #secondary -->
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
                <div class="<?php echo ( is_active_sidebar('woocommerce-widget-area') && (isset( $_GET['has_sidebar'] ) && $_GET['has_sidebar'] == 'true' ) ) ? 'col-xs-12 col-sm-9 col-md-9 col-lg-9' : 'col-xs-12 col-sm-12 col-md-12 col-lg-12'; ?>">
                	<?php
                		/**
