...
$el_class .= ' wpb_column vc_column_container ' . $animation . $border_class.' '.$list_style.$column_style.$class_align;
$style = cshero_build_style($styles);

$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $width . ' '.  $image_transition_class .' ' . $el_class . $responsive, $this->settings['base'], $atts );
