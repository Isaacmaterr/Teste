...
$output .= "\n\t".'<div id = "cshero-accordion-'.$uqid.'" class="'.$css_class.' '.$vc_accordion_style.'" data-collapsible="'.$collapsible.'" data-vc-disable-keydown="' . ( esc_attr( ( 'yes' == $disable_keyboard ? 'true' : 'false' ) ) ) . '" data-active-tab="'.$active_tab.'">'; //data-interval="'.$interval.'"
