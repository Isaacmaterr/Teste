...
*/
get_header();
global $wp_query,$paged, $post, $breadcrumb; 
$cat_id = !empty($_REQUEST['cat_id']) ? $_REQUEST['cat_id'] : null;
?>
<?php $layout = cshero_generetor_layout();?>
    <section id="primary" class="content-area<?php if($breadcrumb == '0'){ echo ' no_breadcrumb_page'; }; ?> blog-classic-style1<?php echo esc_attr($layout->class); ?>">
