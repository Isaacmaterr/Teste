...
<article id="post-<?php the_ID(); ?>" <?php  post_class(); ?>>
    <div class="cshero-team-image-wrap">
        ...
        <?php } else { ?>
            ...
            ?>
            <div class="cshero-team-image no-image clearfix">
                <?php if($crop_image){ ?>
        ...
        <div class="cshero-team-content-overlay">
            ...
            <div class="cshero-team-info-wrap">
                <?php  if($show_team_position) {                            
                    ...
                    if ($team_position) { ?>
                    <div class="cshero-team-position"><?php echo strip_tags ($team_position); ?></div>
                <?php } } ?>
