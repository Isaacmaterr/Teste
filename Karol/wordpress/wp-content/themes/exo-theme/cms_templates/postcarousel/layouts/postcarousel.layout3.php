    ...
    <div class="cshero-carousel-container">
        <div class="cshero-carousel-image clearfix" <?php echo $crop_image_size;?>>
            ...
            if (has_post_thumbnail() and wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), 'full', false)){
                ...
                if($crop_image){
                    ...
                    echo '<a title="" href="' . esc_url(get_the_permalink())  . '" ><img alt=""  src="'. $image_resize .'" '.$image_style.' /></a>';
                }else{
                   echo '<a title="" href="' . esc_url(get_the_permalink())  . '" ><img alt src="'. esc_attr($attachment_image[0]) .'"   '.$image_style.'  /></a>';
                }
            } else {
            ...
            <?php if($show_read_more || $show_popup): ?>
                <div class="overlay" style="background-color: <?php echo $overlay_bg_color;?>;">
        ...
        <div class="cshero-carousel-body" <?php echo $content_style;?>>
            <div class="cshero-carousel-inner clearfix">
                ...
                <?php endif; ?>
                <div class="cshero-carousel-content-wrap">
                    <?php if ($show_category) : ?>
                            <span class="cshero-carousel-category">
                                <?php echo _e("",CSCORE_NAME).' '; echo strip_tags (get_the_term_list($post->ID, 'category', '', ', ', '')); ?>
                            </span>
                        <?php endif; ?>
                    <?php if ($show_title) { ?>
