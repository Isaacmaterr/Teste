        ...
        <div class="cshero-portfolio-wrapper">
            ...
            <div class="cshero-portfolio-content-wrapper">
                <div class="cshero-portfolio-content-inner">
                    <?php
                        if ($show_title) {
                            echo '<'.$title_size.' style="color:'.$title_color.';" class="cshero-portfolio-title">' . get_the_title() . '</'.$title_size.'>';
                        }
                        if ($show_category) {
            ...
            <span class="overlay-content" style="background-color: <?php echo "".$item_bg_color; ?>;"></span>
