    ...
    array(
        ...
        array(
            ...
            "value" => array(
                ...
                'Button Default Color' => 'btn btn-default-color',
                'Button Default Border' => 'btn btn-default',
                'Button Default Alternate Color' => 'btn btn-default-alt',
                'Button Primary' => 'btn btn-primary',
                'Button Primary Color' => 'btn btn-primary-color',
                'Button Primary Border' => 'btn btn-primary-border',
                'Button Primary Alternate Color' => 'btn btn-primary-alt',
        ...
        array(
            ...
            "value" => array(
                ...
                'Mini' => 'btn-xs btn-mini',
                'Small' => 'btn-sm btn-small',
                'Medium' => 'btn-md btn-medium',
                'Large' => 'btn-lg btn-large',
            ),
        ...
        array(
            "type" => "colorpicker",
            "class" => "",
            "heading" => __("Custom Backkground Color - Hover", THEMENAME),
            "param_name" => "custom_btn_bg_hover",
            "value" => "",
            "description" => "",
        ),
    ),
